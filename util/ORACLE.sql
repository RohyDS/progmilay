-- ORACLE SQL Script for progmilay

-- Nettoyage des tables existantes
DROP TABLE pause CASCADE CONSTRAINTS;
DROP TABLE obstacle CASCADE CONSTRAINTS;
...
DROP SEQUENCE seq_voiture;

-- 1. Séquences
CREATE SEQUENCE seq_voiture START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
CREATE SEQUENCE seq_point START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
...
CREATE SEQUENCE seq_pause START WITH 1 INCREMENT BY 1 NOCACHE NOCYCLE;
...
-- 7. Insertions des données (Utilisation de sous-requêtes pour garantir les IDs)
...
-- Routes (Récupération des IDs des points par leurs noms)
INSERT INTO route (id, nom, idpointdepart, idpointdesti, distance, largeur) 
VALUES (seq_route.NEXTVAL, 'Antananarivo-Sambaina', (SELECT id FROM point WHERE nom='Antananarivo'), (SELECT id FROM point WHERE nom='Sambaina'), 200, 3.50);

INSERT INTO route (id, nom, idpointdepart, idpointdesti, distance, largeur) 
VALUES (seq_route.NEXTVAL, 'Sambaina-Antsirabe', (SELECT id FROM point WHERE nom='Sambaina'), (SELECT id FROM point WHERE nom='Antsirabe'), 120, 4.00);

INSERT INTO route (id, nom, idpointdepart, idpointdesti, distance, largeur) 
VALUES (seq_route.NEXTVAL, 'Antananarivo-Ampefy', (SELECT id FROM point WHERE nom='Antananarivo'), (SELECT id FROM point WHERE nom='Ampefy'), 163, 3.00);

INSERT INTO route (id, nom, idpointdepart, idpointdesti, distance, largeur) 
VALUES (seq_route.NEXTVAL, 'Ampefy-sambaina', (SELECT id FROM point WHERE nom='Ampefy'), (SELECT id FROM point WHERE nom='Sambaina'), 88, 3.75);

-- Obstacles (Récupération de l'ID de la route par son nom)
INSERT INTO obstacle (id, taux_ralentissement, km_depart, km_arrivee, idroute) 
VALUES (seq_obstacle.NEXTVAL, 11, 56, 70, (SELECT id FROM route WHERE nom='Antananarivo-Sambaina'));

-- Pauses
INSERT INTO pause (id, id_route, position_km, heure_debut, heure_fin) 
VALUES (seq_pause.NEXTVAL, (SELECT id FROM route WHERE nom='Antananarivo-Sambaina'), 70, '13:00', '13:30');

INSERT INTO pause (id, id_route, position_km, heure_debut, heure_fin) 
VALUES (seq_pause.NEXTVAL, (SELECT id FROM route WHERE nom='Sambaina-Antsirabe'), 60, '14:00', '15:00');

INSERT INTO pause (id, id_route, position_km, heure_debut, heure_fin) 
VALUES (seq_pause.NEXTVAL, (SELECT id FROM route WHERE nom='Antananarivo-Ampefy'), 30, '10:30', '10:45');

INSERT INTO pause (id, id_route, position_km, heure_debut, heure_fin) 
VALUES (seq_pause.NEXTVAL, (SELECT id FROM route WHERE nom='Ampefy-sambaina'), 80, '15:00', '15:20');
